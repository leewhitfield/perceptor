...
def _summary_for_group(items: list[dict[str, Any]], serial: str) -> dict[str, Any]:
    ...
    return {
        ...
        "partition_disk_number": _join_unique(items, "partition_disk_number"),
        "partition_bus_type": _join_unique(items, "partition_bus_type"),
        "partition_bus_type_code": _join_unique(items, "partition_bus_type_code"),
        "partition_user_removal_policy": _join_unique(items, "partition_user_removal_policy"),
        "partition_bytes_per_sector": _join_unique(items, "partition_bytes_per_sector", exclude={"0"}),
        "partition_bytes_per_logical_sector": _join_unique(items, "partition_bytes_per_logical_sector", exclude={"0"}),
        "partition_bytes_per_physical_sector": _join_unique(items, "partition_bytes_per_physical_sector", exclude={"0"}),
        "partition_style": _join_unique(items, "partition_style"),
        "partition_style_code": _join_unique(items, "partition_style_code"),
        "partition_count": _join_unique(items, "partition_count", exclude={"0"}),
        "partition_table_bytes": _join_unique(items, "partition_table_bytes", exclude={"0"}),
        "partition_table_sha256": _join_unique(items, "partition_table_sha256"),
        "partition_table_summary": _join_unique(items, "partition_table_summary"),
        "partition_table_disk_guid": _join_unique(items, "partition_table_disk_guid"),
        "storage_id_code_set": _join_unique(items, "storage_id_code_set"),
        "storage_id_type": _join_unique(items, "storage_id_type"),
        "storage_id_association": _join_unique(items, "storage_id_association"),
        "storage_id_bytes": _join_unique(items, "storage_id_bytes", exclude={"0"}),
        ...
        "partition_registry_id": _join_unique(items, "partition_registry_id"),
        "partition_adapter_id": _join_unique(items, "partition_adapter_id"),
        "partition_pool_id": _join_unique(items, "partition_pool_id", exclude={"00000000-0000-0000-0000-000000000000"}),
        "partition_location": _join_unique(items, "partition_location"),
        "partition_flags": _join_unique(items, "partition_flags"),
        "partition_characteristics": _join_unique(items, "partition_characteristics"),
        "vbr_oem_name": _join_unique(items, "vbr_oem_name"),
        "vbr_file_system": _join_unique(items, "vbr_file_system"),
        ...
        "vbr_parse_status": _join_unique(items, "vbr_parse_status"),
        "vbr_serial_match": _join_unique(items, "vbr_serial_match"),
        "mbr_partition_type": _join_unique(items, "mbr_partition_type"),
