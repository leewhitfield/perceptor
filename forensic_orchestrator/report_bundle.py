...
from forensic_orchestrator.tools.usb_summary import (
    rebuild_usb_connection_events,
    rebuild_usb_media_instances,
    rebuild_usb_storage_devices,
)
...
def _run_post_import_rebuilds(db: Database, *, case_id: str, image_id: str) -> list[str]:
    ...
    rebuild_usb_media_instances(db, case_id=case_id, image_id=image_id)
